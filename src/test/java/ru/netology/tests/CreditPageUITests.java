...
@Epic("UI-тесты Credit Gate")
public class CreditPageUITests {
    ...
    public void shouldSuccessCredit() {
        ...
        initialPage.credit();
        var creditPage = new FormPage();
        creditPage.fillOutForm(cardInfo.getNumber(), cardInfo.getMonth(), cardInfo.getYear(),
    ...
    public void shouldSuccessCreditWithLowerCaseHolder() {
        CardInfo cardInfo = new CardInfo(getValidApprovedNumberCard(), generateMonth(1),
        ...
        creditPage.successNotification();
        creditPage.matchInsertValueHolder(holder);
    }
    ...
    public void shouldNotSuccessCreditWithInvalidCardNumber() {
